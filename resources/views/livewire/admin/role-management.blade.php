                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-300 dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center space-x-2">
                                <button wire:click="openEditModal({{ $role->id }})" class="flex items-center justify-center text-warning hover:text-warning-strong shadow-xs font-medium leading-5 rounded-base text-sm p-1.5 focus:outline-none cursor-pointer">
                                ...
                                <button wire:click="openDeleteModal({{ $role->id }})" class="flex items-center justify-center text-danger hover:text-danger-strong shadow-xs font-medium leading-5 rounded-base text-sm p-1.5 focus:outline-none cursor-pointer">
            ...
            <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-800 p-4 sm:p-5">
                ...
                <form wire:submit.prevent="createRole" class="space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model="role_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="misal: Admin, Perawat, Dokter" required>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs">
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <p class="mb-4 text-gray-900 dark:text-gray-900">Apakah Anda yakin ingin menghapus role ini?</p>
