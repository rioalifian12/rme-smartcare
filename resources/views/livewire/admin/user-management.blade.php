                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-300 dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center space-x-2">
                                {{-- Tombol Edit --}}
                                <button wire:click="openEditModal({{ $user->id }})" title="Edit User" class="flex items-center justify-center text-warning hover:text-warning-strong p-1.5 focus:outline-none cursor-pointer">
                                ...
                                <button wire:click="openResetModal({{ $user->id }})" title="Reset Password" class="flex items-center justify-center text-blue-600 hover:text-blue-800 p-1.5 focus:outline-none cursor-pointer">
                                ...
                                {{-- Tombol Hapus --}}
                                <button wire:click="openDeleteModal({{ $user->id }})" title="Hapus User" class="flex items-center justify-center text-danger hover:text-danger-strong p-1.5 focus:outline-none cursor-pointer">
            ...
            <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-800 p-4 sm:p-5">
                ...
                <form wire:submit.prevent="createUser" class="space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400" placeholder="Nama Lengkap" required>
                        @error('name') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                        <input type="email" wire:model="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400" placeholder="Masukkan email" required>
                        @error('email') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                        <input type="password" wire:model="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400" placeholder="Masukkan password" required>
            ...
            <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-800 p-4 sm:p-5">
                ...
                <form wire:submit.prevent="resetUserPassword" class="space-y-4">
                    <div>
                        ...
                        <input type="password" wire:model="reset_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-base block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400" placeholder="Masukkan password baru" required>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs">
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <p class="mb-4 text-gray-900 dark:text-white">Apakah Anda yakin ingin menghapus user ini?</p>
